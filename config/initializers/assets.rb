...
#Rails.application.config.assets.precompile += %w( jsidemenu.scss )
...
#Rails.application.config.assets.precompile += %w( colorpicker/jquery.simplecolorpicker-fontawesome.scss )
...
#Rails.application.config.assets.precompile += %w( pickadate/classic.scss )
#Rails.application.config.assets.precompile += %w( pickadate/classic.date.scss )
...
Rails.application.config.assets.precompile += %w( mains.js )
#Rails.application.config.assets.precompile += %w( gthread_destroy.js )
Rails.application.config.assets.precompile += %w( mains_resize.js )
Rails.application.config.assets.precompile += %w( community_edit_modal_resize.js )
Rails.application.config.assets.precompile += %w( mains_show.js )
...
Rails.application.config.assets.precompile += %w( gthreads.js )
...
Rails.application.config.assets.precompile += %w( pickadate/picker.js )
Rails.application.config.assets.precompile += %w( pickadate/picker.date.js )
Rails.application.config.assets.precompile += %w( pickadate/legacy.js )
Rails.application.config.assets.precompile += %w( pickadate/ja_JP.js )
...
# jsidemenu
#Rails.application.config.assets.precompile += %w( jquery.jside.menu.js )