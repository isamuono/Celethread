...
function resizeElement(){
  ...
  //const resizebox1 = document.getElementById("image");
  //  if (windowWidth <= 767) {
  //    resizebox1.className = "custom-file-input";
  //  } else if (windowWidth >= 768) {
  //    resizebox1.className = "custom-file-input";
  //  }
  const resizebox2 = document.getElementById("family_name");
    if (windowWidth <= 767) {
  ...
  const resizebox3 = document.getElementById("first_name");
    if (windowWidth <= 767) {
  ...
  const resizebox4 = document.getElementById("accountName");
    if (windowWidth <= 767) {
  ...
  const resizebox5 = document.getElementById("email");
    if (windowWidth <= 767) {
